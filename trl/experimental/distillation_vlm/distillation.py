...
```
python trl/experimental/distillation_vlm/distillation.py \
...
def main(script_args, training_args, model_args):
    ...
    from trl.experimental.distillation_vlm import DistillationTrainer
...
def make_parser(subparsers: argparse._SubParsersAction | None = None, prog: str | None = None):
    ...
    from trl.experimental.distillation_vlm import DistillationConfig
